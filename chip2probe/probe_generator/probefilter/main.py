...
sys.path.append("/Users/faricazjj/Box/homotf/chip2probe/")
sys.path.append('/Users/faricazjj/Box/homotf/chip2probe/probe_generator/probefilter/libsvm-3.24/python')
import pandas as pd
import itertools
import os
