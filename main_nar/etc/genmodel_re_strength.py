...
if __name__ == "__main__":
    ...
    pl.plot_model_metrics(best_models, path="%s/model/auc_separate_str.png" % basepath, cvfold=10, score_type="auc", varyline=True, title="Average ROC Curves for Runx1-Ets1", interp=True)
